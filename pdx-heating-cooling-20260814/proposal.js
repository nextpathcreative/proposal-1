  ...
  function schedulerHTML() {
    ...
    if (state.step === 1) {
      ...
      s += '<div class="sched-form">' +
        ...
        '<div class="field"><label>Your business <span style="color:var(--fg-subtle);font-weight:400;">(optional)</span></label><input class="input" data-f="biz" value="' + esc(state.form.biz) + '" placeholder="PDX Heating & Cooling"></div>' +
        '</div>';
      s += '<div class="sched-foot">' +
